...
This project demonstrates end-to-end data analytics skills using real business-style datasets.
I designed and executed a structured analysis workflow to explore customer behavior, product performance, and business trends using SQL.
...
- Build trend and cumulative growth insights

- Identify key segments and contribution patterns
...
- What is the cumulative impact of customer and product activities?

- Which products and customer groups drive the most value?

- What segments show the strongest performance trends?
